...
// declare string for nn
string fwfs_nn_name, nn_name;
...
int main(int argc, char *argv[]) {
    ...
    if (argv[7]) {
        nn_init_user_selection = argv[7];
    } else {
        nn_init_user_selection = "Disable";
    }
...
//    system(cmd.c_str());
    ...
    if (video_init_user_selection == "Enable") {
        ...
        cout << cmd << endl;
        system(cmd.c_str());
    } else if (nn_init_user_selection == "Enable") {
        readtxt(4);
